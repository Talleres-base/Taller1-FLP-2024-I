...
(check-equal? #T (verify-nodes adj-g1-b (get-adjacent g1 (node-symbol 'b))))
(check-equal? #T (verify-nodes adj-g2-3 (get-adjacent g2 (node-int 3))))
(check-equal? #T (verify-nodes adj-g3-10 (get-adjacent g3 (node-int 10))))
(check-equal? #T (verify-nodes adj-g3-6 (get-adjacent g3 (node-int 6))))
